  ...
  return (
    <div className='py-3'>
      <div className='flex flex-wrap items-center justify-center pb-2'>
        <div>
          <select
            className='h-[40px] w-[80px] cursor-pointer flex-wrap border py-2 text-center outline-none transition-all duration-300 hover:border-theme-btn-secondary sm:w-[150px]'
            value={selectInput}
        ...
        <div className='mx-2 sm:mx-6 sm:w-[160px]'>
        ...
        <button
          ...
          className='root-btn h-[40px] bg-theme-btn-secondary text-white max-[370px]:mt-4 max-[370px]:w-full'
        >
          Save
        </button>
      </div>
                  ...
                  <div key={colIdx} className={className} style={{ aspectRatio: '1/1' }}>
                    {isQueen || isCurrentItem ? (
                      <div className='flex h-full items-center justify-center overflow-hidden'>
                        <svg viewBox='0 0 70 62' fill='none' xmlns='http://www.w3.org/2000/svg'>
                          <path
